...
func TestParentToEmbeddedMapping(t *testing.T) {
	...
	t.Run("Embedded node maps nested field from parent", func(t *testing.T) {
		...
		parentBytes, _ := json.Marshal(parentOutput)
		parentResponse := embedded.WrapSuccess("parent", "test", 0, parentBytes)
	...
	t.Run("Multiple embedded nodes chain mappings from parent", func(t *testing.T) {
		...
		parentBytes, _ := json.Marshal(parentOutput)
		parentResponse := embedded.WrapSuccess("stage-data", "test", 0, parentBytes)
	...
	t.Run("Embedded node triggers on parent success event", func(t *testing.T) {
		...
		parentBytes, _ := json.Marshal(parentOutput)
		parentResponse := embedded.WrapSuccess("api-call", "test", 0, parentBytes)
	...
	t.Run("Embedded node triggers on parent error event", func(t *testing.T) {
		// Parent failed - use WrapError directly
		parentResponse := embedded.WrapError("api-call", "test", 0, fmt.Errorf("HTTP_TIMEOUT: Request timed out"))
	...
	t.Run("Real-world ep.json pattern: AMQP parent with JSON parser child", func(t *testing.T) {
		...
		parentBytes, _ := json.Marshal(parentOutput)
		parentResponse := embedded.WrapSuccess("07d21e5e-b8d6-40e2-881e-d1f6fe6e7d51", "plugin-amqp", 0, parentBytes)
